...
.. toctree::
   ...
   Proxy Servers <resource_planning/proxy_server_and_transport_modes>
   ...
   Windows Server 2012 Deduplication <resource_planning/repository_type_dedupe_win2012>
   ...
   vPower NFS and Virtual Lab <resource_planning/vpower_nfs_and_virtual_lab>
   WAN Acceleration <resource_planning/wan_acceleration>
   Tape Support <resource_planning/tape_support>
   Veeam Explorers <resource_planning/veeam_explorers>
   Interaction with vSphere <resource_planning/interaction_with_vsphere>
